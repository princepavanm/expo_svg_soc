...
// for UART timer RAL integration
...
module tb_fpga_shield;
  ...
  //apf_if wdog_if(tb_fpga_shield.u_fpga_top.u_fpga_system.u_user_partition.u_mps2_peripherals_wrapper.u_beetle_peripherals_fpga_subsystem.u_cmsdk_apb_watchdog.PCLK, tb_fpga_shield.u_fpga_top.u_fpga_system.u_user_partition.u_mps2_peripherals_wrapper.u_beetle_peripherals_fpga_subsystem.u_cmsdk_apb_watchdog.WDOGCLK);

initial
begin
	//************** Config_db and vars **** 
	//uvm_config_db #(virtual apb_if)::set("null","tb_fpga_shield.u_fpga_top.u_fpga_system.u_user_partition.u_mps2_peripherals_wrapper.u_beetle_peripherals_fpga_subsystem.u_cmsdk_apb_watchdog", "vif_0", wdog_if);
     // uvm_config_db #(virtual apb_if)::set(uvm_root::get(),"*", "vif_0", wdog_if);
//	run_test("test");
end
